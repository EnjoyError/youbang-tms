...
public class HQL {
	 ...
	 * @return
	 */
	public HQL criteria(String property, String propertyKey, MatchType type, Object propertyValue, AndOr andOr) {
	...
	public HQL or(String[] properties, MatchType[] matchTypes, Object[] values) {
		...
		if (properties.length == 1) {
			...
			return criteria(properties[0], properties[0], matchTypes[0], value, AndOr.OR);
		}
